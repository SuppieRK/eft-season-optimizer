...
- Add a left-column exclusive accordion for Battle Pass pages, with exactly one page open at a time, reward checkboxes as the only controls inside page bodies, and global Claim all and Clear all actions in the rail heading while preserving reward prerequisite relationships.
